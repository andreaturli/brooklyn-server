...
public class BrooklynApiRestClientTest {
    ...
    public void testCloudResourceApi() throws Exception {
        log.info("Testing Cloud Resource API");
        List<NodeMetadataSummary> nodes = api.getLocationApi().listNodes("softlayer-mil-1");
        for (NodeMetadataSummary node : nodes) {
